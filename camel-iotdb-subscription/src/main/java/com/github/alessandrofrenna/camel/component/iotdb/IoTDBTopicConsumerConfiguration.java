...
/**
 * The <b>IoTDBTopicConsumerConfiguration</b> class keeps track of the uri parameters used by the
 * consumer.
 */
@UriParams
public class IoTDBTopicConsumerConfiguration {
  ...
  @Metadata(
      ...
      description =
          "The consumer group id that contains the topic consumer. Randomly assigned if not provided")
  ...
  /**
   * Get the consumer group id passed as route uri parameter.</br> The value of consumer group id is
   * optional. If not defined it will be randomly assigned.
   *
  ...
  /**
   * Get the consumer id passed as route uri parameter.</br> The value of consumer id is optional.
   * If not defined it will be randomly assigned.
   *
   * @return an optional wrapping the consumer group id
   */
  ...
  /**
   * Get the heartbeat interval used by the consumer to perform healthcheck.</br> This value is
   * optional. If not provided this method returns the default value of 30_000ms (30s).
   *
   ...
   *
   * @param heartbeatIntervalMs milliseconds interval used by the consumer to perform healthcheck
   *     against IoTDB
   */
  ...
  /**
   * Get the synchronization interval used by the consumer to sync against IoTDB.</br> This value is
   * optional. If not provided this method returns the default value of 120_000ms (120s).
   *
